...
# [repr (C)]
pub struct RegisterBlock { _reserved_0_csr : [u8 ; 5usize]
, } impl RegisterBlock { # [doc = "0x00 - Control and Status Register"]
# [inline (always)]
pub fn csr (& self) -> & CSR { unsafe { & * (((self as * const Self) as * const u8) . add (0usize) as * const CSR) } } # [doc = "0x00 - Control and Status Register"]
# [inline (always)]
pub fn csr_mut (& self) -> & mut CSR { unsafe { & mut * (((self as * const Self) as * mut u8) . add (0usize) as * mut CSR) } } # [doc = "0x01 - Global LED string brightness"]
# [inline (always)]
pub fn glob (& self) -> & GLOB { unsafe { & * (((self as * const Self) as * const u8) . add (1usize) as * const GLOB) } } # [doc = "0x01 - Global LED string brightness"]
# [inline (always)]
pub fn glob_mut (& self) -> & mut GLOB { unsafe { & mut * (((self as * const Self) as * mut u8) . add (1usize) as * mut GLOB) } } } # [doc = "Control and Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [csr](csr) module"]
pub type CSR = crate :: Reg < u32 , _CSR > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _CSR ; # [doc = "`read()` method returns [csr::R](csr::R) reader structure"]
impl crate :: Readable for CSR { } # [doc = "`write(|w| ..)` method takes [csr::W](csr::W) writer structure"]
...
pub type W = crate :: W < u32 , super :: GLOB > ; # [doc = "Register GLOB `reset()`'s with value 0"]
impl crate :: ResetValue for super :: GLOB { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `GLOB`"]
...
# [inline (always)]
pub fn glob (& mut self) -> GLOB_W { GLOB_W { w : self } } } } } # [no_mangle]
...
pub LEDSTR : LEDSTR , } impl Peripherals { # [doc = r"Returns all the peripherals *once*"]
# [inline]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { UART : UART { _marker : PhantomData } , RGBLED : RGBLED { _marker : PhantomData } , LEDSTR : LEDSTR { _marker : PhantomData } , } } }
