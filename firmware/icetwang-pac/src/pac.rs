...
# [inline (always)]
pub fn right (& mut self) -> RIGHT_W { RIGHT_W { w : self } } } } } # [no_mangle]
...
pub JOY : JOY , } impl Peripherals { # [doc = r"Returns all the peripherals *once*"]
# [inline]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { UART : UART { _marker : PhantomData } , RGBLED : RGBLED { _marker : PhantomData } , LEDSTR : LEDSTR { _marker : PhantomData } , TIMER : TIMER { _marker : PhantomData } , JOY : JOY { _marker : PhantomData } , } } }
