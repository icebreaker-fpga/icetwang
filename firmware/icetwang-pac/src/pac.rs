...
pub type R = crate :: R < u32 , super :: COUNTER > ; impl R { } } } # [doc = "JOY"]
pub struct JOY { _marker : PhantomData < * const () > } unsafe impl Send for JOY { } impl JOY { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const joy :: RegisterBlock { 0x8800_0000 as * const _ } } impl Deref for JOY { type Target = joy :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * JOY :: ptr () } } } # [doc = "JOY"]
pub mod joy { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - Joystick button state"]
pub joy : JOY , } # [doc = "Joystick button state\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [joy](joy) module"]
pub type JOY = crate :: Reg < u32 , _JOY > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _JOY ; # [doc = "`read()` method returns [joy::R](joy::R) reader structure"]
impl crate :: Readable for JOY { } # [doc = "`write(|w| ..)` method takes [joy::W](joy::W) writer structure"]
impl crate :: Writable for JOY { } # [doc = "Joystick button state"]
pub mod joy { # [doc = "Reader of register JOY"]
pub type R = crate :: R < u32 , super :: JOY > ; # [doc = "Writer for register JOY"]
pub type W = crate :: W < u32 , super :: JOY > ; # [doc = "Register JOY `reset()`'s with value 0"]
impl crate :: ResetValue for super :: JOY { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `UP`"]
pub type UP_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `UP`"]
pub struct UP_W < 'a > { w : & 'a mut W , } impl < 'a > UP_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0x01) | ((value as u32) & 0x01) ; self . w } } # [doc = "Reader of field `DOWN`"]
pub type DOWN_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `DOWN`"]
pub struct DOWN_W < 'a > { w : & 'a mut W , } impl < 'a > DOWN_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x01 << 1)) | (((value as u32) & 0x01) << 1) ; self . w } } # [doc = "Reader of field `LEFT`"]
pub type LEFT_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `LEFT`"]
pub struct LEFT_W < 'a > { w : & 'a mut W , } impl < 'a > LEFT_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x01 << 2)) | (((value as u32) & 0x01) << 2) ; self . w } } # [doc = "Reader of field `RIGHT`"]
pub type RIGHT_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `RIGHT`"]
pub struct RIGHT_W < 'a > { w : & 'a mut W , } impl < 'a > RIGHT_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x01 << 3)) | (((value as u32) & 0x01) << 3) ; self . w } } impl R { # [doc = "Bit 0 - Joystick Up"]
# [inline (always)]
pub fn up (& self) -> UP_R { UP_R :: new ((self . bits & 0x01) != 0) } # [doc = "Bit 1 - Joystick Down"]
# [inline (always)]
pub fn down (& self) -> DOWN_R { DOWN_R :: new (((self . bits >> 1) & 0x01) != 0) } # [doc = "Bit 2 - Joystick Left"]
# [inline (always)]
pub fn left (& self) -> LEFT_R { LEFT_R :: new (((self . bits >> 2) & 0x01) != 0) } # [doc = "Bit 3 - Joystick Right"]
# [inline (always)]
pub fn right (& self) -> RIGHT_R { RIGHT_R :: new (((self . bits >> 3) & 0x01) != 0) } } impl W { # [doc = "Bit 0 - Joystick Up"]
# [inline (always)]
pub fn up (& mut self) -> UP_W { UP_W { w : self } } # [doc = "Bit 1 - Joystick Down"]
# [inline (always)]
pub fn down (& mut self) -> DOWN_W { DOWN_W { w : self } } # [doc = "Bit 2 - Joystick Left"]
# [inline (always)]
pub fn left (& mut self) -> LEFT_W { LEFT_W { w : self } } # [doc = "Bit 3 - Joystick Right"]
# [inline (always)]
pub fn right (& mut self) -> RIGHT_W { RIGHT_W { w : self } } } } } # [doc = "I2C"]
pub struct I2C { _marker : PhantomData < * const () > } unsafe impl Send for I2C { } impl I2C { # [doc = r"Returns a pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const i2c :: RegisterBlock { 0x8900_0000 as * const _ } } impl Deref for I2C { type Target = i2c :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * I2C :: ptr () } } } # [doc = "I2C"]
pub mod i2c { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { # [doc = "0x00 - Readwrite register"]
pub dat : DAT , } # [doc = "Readwrite register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dat](dat) module"]
pub type DAT = crate :: Reg < u32 , _DAT > ; # [allow (missing_docs)]
# [doc (hidden)]
pub struct _DAT ; # [doc = "`read()` method returns [dat::R](dat::R) reader structure"]
impl crate :: Readable for DAT { } # [doc = "`write(|w| ..)` method takes [dat::W](dat::W) writer structure"]
impl crate :: Writable for DAT { } # [doc = "Readwrite register"]
pub mod dat { # [doc = "Reader of register DAT"]
pub type R = crate :: R < u32 , super :: DAT > ; # [doc = "Writer for register DAT"]
pub type W = crate :: W < u32 , super :: DAT > ; # [doc = "Register DAT `reset()`'s with value 0"]
impl crate :: ResetValue for super :: DAT { type Type = u32 ; # [inline (always)]
fn reset_value () -> Self :: Type { 0 } } # [doc = "Reader of field `DATA`"]
pub type DATA_R = crate :: R < u8 , u8 > ; # [doc = "Write proxy for field `DATA`"]
pub struct DATA_W < 'a > { w : & 'a mut W , } impl < 'a > DATA_W < 'a > { # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub unsafe fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! 0xff) | ((value as u32) & 0xff) ; self . w } } # [doc = "Reader of field `ACK`"]
pub type ACK_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `ACK`"]
pub struct ACK_W < 'a > { w : & 'a mut W , } impl < 'a > ACK_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x01 << 8)) | (((value as u32) & 0x01) << 8) ; self . w } } # [doc = "Set command type.\n\nValue on reset: 0"]
# [derive (Clone , Copy , Debug , PartialEq)]
# [repr (u8)]
pub enum CMD_A { # [doc = "0: Start condition"]
START = 0 , # [doc = "1: Stop condition"]
STOP = 1 , # [doc = "2: Write access"]
WRITE = 2 , # [doc = "3: Read access"]
READ = 3 } impl From < CMD_A > for u8 { # [inline (always)]
fn from (variant : CMD_A) -> Self { variant as _ } } # [doc = "Reader of field `CMD`"]
pub type CMD_R = crate :: R < u8 , CMD_A > ; impl CMD_R { # [doc = r"Get enumerated values variant"]
# [inline (always)]
pub fn variant (& self) -> CMD_A { match self . bits { 0 => CMD_A :: START , 1 => CMD_A :: STOP , 2 => CMD_A :: WRITE , 3 => CMD_A :: READ , _ => unreachable ! () } } # [doc = "Checks if the value of the field is `START`"]
# [inline (always)]
pub fn is_start (& self) -> bool { * self == CMD_A :: START } # [doc = "Checks if the value of the field is `STOP`"]
# [inline (always)]
pub fn is_stop (& self) -> bool { * self == CMD_A :: STOP } # [doc = "Checks if the value of the field is `WRITE`"]
# [inline (always)]
pub fn is_write (& self) -> bool { * self == CMD_A :: WRITE } # [doc = "Checks if the value of the field is `READ`"]
# [inline (always)]
pub fn is_read (& self) -> bool { * self == CMD_A :: READ } } # [doc = "Write proxy for field `CMD`"]
pub struct CMD_W < 'a > { w : & 'a mut W , } impl < 'a > CMD_W < 'a > { # [doc = r"Writes `variant` to the field"]
# [inline (always)]
pub fn variant (self , variant : CMD_A) -> & 'a mut W { { self . bits (variant . into ()) } } # [doc = "Start condition"]
# [inline (always)]
pub fn start (self) -> & 'a mut W { self . variant (CMD_A :: START) } # [doc = "Stop condition"]
# [inline (always)]
pub fn stop (self) -> & 'a mut W { self . variant (CMD_A :: STOP) } # [doc = "Write access"]
# [inline (always)]
pub fn write (self) -> & 'a mut W { self . variant (CMD_A :: WRITE) } # [doc = "Read access"]
# [inline (always)]
pub fn read (self) -> & 'a mut W { self . variant (CMD_A :: READ) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bits (self , value : u8) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x03 << 12)) | (((value as u32) & 0x03) << 12) ; self . w } } # [doc = "Reader of field `READY`"]
pub type READY_R = crate :: R < bool , bool > ; # [doc = "Write proxy for field `READY`"]
pub struct READY_W < 'a > { w : & 'a mut W , } impl < 'a > READY_W < 'a > { # [doc = r"Sets the field bit"]
# [inline (always)]
pub fn set_bit (self) -> & 'a mut W { self . bit (true) } # [doc = r"Clears the field bit"]
# [inline (always)]
pub fn clear_bit (self) -> & 'a mut W { self . bit (false) } # [doc = r"Writes raw bits to the field"]
# [inline (always)]
pub fn bit (self , value : bool) -> & 'a mut W { self . w . bits = (self . w . bits & ! (0x01 << 31)) | (((value as u32) & 0x01) << 31) ; self . w } } impl R { # [doc = "Bits 0:7 - Write data to send, read received data."]
# [inline (always)]
pub fn data (& self) -> DATA_R { DATA_R :: new ((self . bits & 0xff) as u8) } # [doc = "Bit 8 - Write ack out, read ack in."]
# [inline (always)]
pub fn ack (& self) -> ACK_R { ACK_R :: new (((self . bits >> 8) & 0x01) != 0) } # [doc = "Bits 12:13 - Set command type."]
# [inline (always)]
pub fn cmd (& self) -> CMD_R { CMD_R :: new (((self . bits >> 12) & 0x03) as u8) } # [doc = "Bit 31 - I2C peripheral ready"]
# [inline (always)]
pub fn ready (& self) -> READY_R { READY_R :: new (((self . bits >> 31) & 0x01) != 0) } } impl W { # [doc = "Bits 0:7 - Write data to send, read received data."]
# [inline (always)]
pub fn data (& mut self) -> DATA_W { DATA_W { w : self } } # [doc = "Bit 8 - Write ack out, read ack in."]
# [inline (always)]
pub fn ack (& mut self) -> ACK_W { ACK_W { w : self } } # [doc = "Bits 12:13 - Set command type."]
# [inline (always)]
pub fn cmd (& mut self) -> CMD_W { CMD_W { w : self } } # [doc = "Bit 31 - I2C peripheral ready"]
# [inline (always)]
pub fn ready (& mut self) -> READY_W { READY_W { w : self } } } } } # [no_mangle]
...
pub TIMER : TIMER , # [doc = "JOY"]
pub JOY : JOY , # [doc = "I2C"]
pub I2C : I2C , } impl Peripherals { # [doc = r"Returns all the peripherals *once*"]
# [inline]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { UART : UART { _marker : PhantomData } , RGBLED : RGBLED { _marker : PhantomData } , LEDSTR : LEDSTR { _marker : PhantomData } , TIMER : TIMER { _marker : PhantomData } , JOY : JOY { _marker : PhantomData } , I2C : I2C { _marker : PhantomData } , } } }
