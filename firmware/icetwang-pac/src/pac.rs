...
# [inline (always)]
pub fn rfempty (& mut self) -> RFEMPTY_W { RFEMPTY_W { w : self } } } } } # [doc = "LED control"]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { UART : UART { _marker : PhantomData } , LED_COMMON : LED_COMMON { _marker : PhantomData } , } } }
